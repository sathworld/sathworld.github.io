...
export const HomeSection = () => {
    return (
        <section id="home" className="relative min-h-screen flex items-center justify-center text-center bg-purple-light dark:bg-purple-dark text-purple-dark dark:text-purple-light">
            <ThreeBackground />
